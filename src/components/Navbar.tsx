    ...
    return (
        <header className="fixed inset-x-0 top-3 z-50">
            <div className="mx-auto max-w-6xl px-3 sm:px-6">
                <div className="rounded-2xl border border-slate-200/70 bg-white/70 p-2 shadow-lg shadow-slate-900/10 backdrop-blur-xl dark:border-white/10 dark:bg-slate-950/50 dark:shadow-black/30">
                    {/* MOBILE */}
                    ...
                    {mobileOpen && (
                        <div className="mt-3 border-t border-slate-200/70 pt-3 dark:border-white/10 md:hidden">
                        ...
                        <Tooltip>
                            <TooltipTrigger asChild>
                                <button
                                    type="button"
                                    aria-label="Cambiar tema"
                                    className="grid h-12 w-12 shrink-0 place-items-center rounded-full border border-slate-200/70 bg-white/80 shadow-md shadow-slate-900/10 transition hover:bg-white focus:outline-none focus:ring-2 focus:ring-blue-400/60 focus:ring-offset-2 focus:ring-offset-transparent dark:border-white/10 dark:bg-slate-950/70 dark:shadow-black/30 dark:hover:bg-slate-950"
                                >
                                    <AnimatedThemeToggler />
                                </button>
                            </TooltipTrigger>
                        ...
                        <Tooltip>
                            <TooltipTrigger asChild>
                                <button
                                    ...
                                    aria-label="Contactar"
                                    onClick={() => scrollToId("contact")}
                                    className="grid h-12 w-12 shrink-0 place-items-center rounded-full border border-slate-200/70 bg-white/80 text-slate-900 shadow-md shadow-slate-900/10 transition hover:bg-white focus:outline-none focus:ring-2 focus:ring-blue-400/60 focus:ring-offset-2 focus:ring-offset-transparent dark:border-white/10 dark:bg-slate-950/70 dark:text-white dark:shadow-black/30 dark:hover:bg-white/10"
                                >
                                    <svg width="18" height="18" viewBox="0 0 24 24" fill="none">
                                        <path
                                            d="M21 8V17a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8m18 0a2 2 0 0 0-2-2H5a2 2 0 0 0-2 2m18 0-9 6-9-6"
